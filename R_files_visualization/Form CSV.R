...
df2 <- df %>%
  ...
  filter(resultado_definitivo == "SARS-CoV-2", toma_muestra == "SI", rango_de_edad != "", fecha_de_registro >= 2020-01-01)%>%
  droplevels()
...
#AGRUPAR NIVELES EN 4; RECUPERADOS, ACTIVOS GRAVES, ACTIVOS, DEFUNCION"

df2$evolucion_caso
levels(df2$evolucion_caso) <-c("RECUPERADOS", "RECUPERADOS", "RECUPERADOS", "RECUPERADOS", "RECUPERADOS", "ACTIVOS GRAVES", "ACTIVOS", "DEFUNCION", "ACTIVOS", "ACTIVOS", "ACTIVOS", "RECUPERADOS")
